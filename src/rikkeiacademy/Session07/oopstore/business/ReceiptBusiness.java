...
public class ReceiptBusiness {
    public static void management(Scanner scanner, Product[] products, int proCurIndex, Order[] orders, int orderCurIndex, Employee[] employees, int empCurIndex) {
        ...
        while (!isExit) {
            ...
            System.out.println(" 1. Input Receipt Information");
            System.out.println(" 2. Display Receipt Information");
            System.out.println(" 3. Update Receipt Information By Id");
            System.out.println(" 4. Find Receipt Form Date To Date");
            System.out.println(" 5. Find Receipt By Created User");
            System.out.println(" 6. Find Receipt By Updated User");
